# Challenge #072: Prompt Slider - Lumina Estates
...
- **Interactive Controls**: Next/Prev buttons, navigation dots, and keyboard support.
- **Progressive Auto-play**: A visual progress bar indicates when the next slide will trigger.
- **Responsive Design**: Optimized for desktop, tablet, and mobile viewing.
- **Glassmorphism**: Modern frosted-glass UI for controls.

## 🛠️ Built With
- **HTML5**: Semantic structure.
- **CSS3**: Custom properties, Flexbox, Animations.
- **JavaScript**: Vanilla ES6 logic for slider transitions.
